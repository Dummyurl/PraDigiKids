...
import com.pratham.pradigikids.ftpSettings.server.TcpListener;
...
public class FsService extends Service implements Runnable {
    ...
    static public final String ACTION_STARTED = "com.pratham.pradigikids.ftpSettings.FTPSERVER_STARTED";
    static public final String ACTION_STOPPED = "com.pratham.pradigikids.ftpSettings.FTPSERVER_STOPPED";
    static public final String ACTION_FAILEDTOSTART = "com.pratham.pradigikids.ftpSettings.FTPSERVER_FAILEDTOSTART";
    static public final String ACTION_UPDATE_NOTIFICATION = "com.pratham.pradigikids.ftpSettings.ACTION_UPDATE_NOTIFICATION";

    // RequestStartStopReceiver listens for these actions to start/stop this server
    static public final String ACTION_START_FTPSERVER = "com.pratham.pradigikids.ftpSettings.ACTION_START_FTPSERVER";
    static public final String ACTION_STOP_FTPSERVER = "com.pratham.pradigikids.ftpSettings.ACTION_STOP_FTPSERVER";
