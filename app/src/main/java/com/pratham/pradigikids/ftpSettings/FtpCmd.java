...
package com.pratham.pradigikids.ftpSettings;

import android.util.Log;

import com.pratham.pradigikids.ftpSettings.server.CmdAPPE;
import com.pratham.pradigikids.ftpSettings.server.CmdCDUP;
import com.pratham.pradigikids.ftpSettings.server.CmdCWD;
import com.pratham.pradigikids.ftpSettings.server.CmdDELE;
import com.pratham.pradigikids.ftpSettings.server.CmdFEAT;
import com.pratham.pradigikids.ftpSettings.server.CmdHASH;
import com.pratham.pradigikids.ftpSettings.server.CmdLIST;
import com.pratham.pradigikids.ftpSettings.server.CmdMDTM;
import com.pratham.pradigikids.ftpSettings.server.CmdMFMT;
import com.pratham.pradigikids.ftpSettings.server.CmdMKD;
import com.pratham.pradigikids.ftpSettings.server.CmdMLSD;
import com.pratham.pradigikids.ftpSettings.server.CmdMLST;
import com.pratham.pradigikids.ftpSettings.server.CmdMap;
import com.pratham.pradigikids.ftpSettings.server.CmdNLST;
import com.pratham.pradigikids.ftpSettings.server.CmdNOOP;
import com.pratham.pradigikids.ftpSettings.server.CmdOPTS;
import com.pratham.pradigikids.ftpSettings.server.CmdPASS;
import com.pratham.pradigikids.ftpSettings.server.CmdPASV;
import com.pratham.pradigikids.ftpSettings.server.CmdPORT;
import com.pratham.pradigikids.ftpSettings.server.CmdPWD;
import com.pratham.pradigikids.ftpSettings.server.CmdQUIT;
import com.pratham.pradigikids.ftpSettings.server.CmdRANG;
import com.pratham.pradigikids.ftpSettings.server.CmdREST;
import com.pratham.pradigikids.ftpSettings.server.CmdRETR;
import com.pratham.pradigikids.ftpSettings.server.CmdRMD;
import com.pratham.pradigikids.ftpSettings.server.CmdRNFR;
import com.pratham.pradigikids.ftpSettings.server.CmdRNTO;
import com.pratham.pradigikids.ftpSettings.server.CmdSITE;
import com.pratham.pradigikids.ftpSettings.server.CmdSIZE;
import com.pratham.pradigikids.ftpSettings.server.CmdSTOR;
import com.pratham.pradigikids.ftpSettings.server.CmdSYST;
import com.pratham.pradigikids.ftpSettings.server.CmdTYPE;
import com.pratham.pradigikids.ftpSettings.server.CmdUSER;
import com.pratham.pradigikids.ftpSettings.server.SessionThread;
...
public abstract class FtpCmd implements Runnable {
    ...
    protected static void dispatchCommand(SessionThread session, String inputString) {
        ...
        com.pratham.pradigikids.ftpSettings.server.FtpCmd cmdInstance = null;
        verb = verb.trim();
        ...
        for (int i = 0; i < cmdClasses.length; i++) {
            ...
            if (cmdClasses[i].getName().equals(verb)) {
                ...
                Constructor<? extends com.pratham.pradigikids.ftpSettings.server.FtpCmd> constructor;
                try {
